...
const ExperienceSection = () => {
  ...
  const backendSkills = [
    ...
    { name: 'APIs and Microservices', level: 'Basic' }
  ];
      ...
      <div className="flex justify-center flex-col">
        <div className="flex gap-8 flex-wrap justify-center">
          <div className="flex-1 p-6 bg-white rounded-3xl border border-gray-400 min-w-[300px]">
            <h2 className="text-gray-600 font-semibold text-3xl mb-8 text-center">Frontend Development</h2>
          ...
          <div className="flex-1 p-6 bg-white rounded-3xl border border-gray-400 min-w-[300px]">
            <h2 className="text-gray-600 font-semibold text-3xl mb-8 text-center">Backend Development</h2>
            <div className="flex text-center flex-wrap gap-8 justify-around">
